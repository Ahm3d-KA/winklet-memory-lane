        ...
        >
          ...
          <div className="relative h-[60vh] w-full overflow-hidden">
            ...
            <div
              ...
              style={{
                backgroundImage: `url('${profile.photoUrl || "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=800"}')`,
              }}
            />
            ...
            >
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-1 text-muted-foreground">
                  ...
                  <span className="text-sm">{profile.distance || "Nearby"}</span>
                </div>
              </div>
            </motion.div>
          </div>

          {/* Bio and Interests section with glassmorphism */}
          <motion.div
